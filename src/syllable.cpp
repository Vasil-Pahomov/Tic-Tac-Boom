...
const char syl_bel_0[] PROGMEM = "–¿";
const char syl_bel_1[] PROGMEM = "œ¿";
const char syl_bel_2[] PROGMEM = "¿À";
const char syl_bel_3[] PROGMEM = " ¿";
const char syl_bel_4[] PROGMEM = "¬¿";
const char syl_bel_5[] PROGMEM = "Õ¿";
const char syl_bel_6[] PROGMEM = "ƒ«";
const char syl_bel_7[] PROGMEM = "¿ƒ";
const char syl_bel_8[] PROGMEM = "¿–";
const char syl_bel_9[] PROGMEM = "¿—";
const char syl_bel_10[] PROGMEM = "ƒ¿";
const char syl_bel_11[] PROGMEM = "—“";
const char syl_bel_12[] PROGMEM = "“¿";
const char syl_bel_13[] PROGMEM = "¿¬";
const char syl_bel_14[] PROGMEM = "À¿";
const char syl_bel_15[] PROGMEM = "–€";
const char syl_bel_16[] PROGMEM = "Ã¿";
const char syl_bel_17[] PROGMEM = "œ–";
const char syl_bel_18[] PROGMEM = "¿Õ";
const char syl_bel_19[] PROGMEM = "–Œ";
const char syl_bel_20[] PROGMEM = "¿÷";
const char syl_bel_21[] PROGMEM = "◊¿";
const char syl_bel_22[] PROGMEM = "¿√";
const char syl_bel_23[] PROGMEM = "¿ ";
const char syl_bel_24[] PROGMEM = "√¿";
const char syl_bel_25[] PROGMEM = "À≤";
const char syl_bel_26[] PROGMEM = "«¿";
const char syl_bel_27[] PROGMEM = "◊€";
const char syl_bel_28[] PROGMEM = "¿Ã";
const char syl_bel_29[] PROGMEM = "Õ≤";
const char syl_bel_30[] PROGMEM = "“–";
const char syl_bel_31[] PROGMEM = "¿◊";
const char syl_bel_32[] PROGMEM = "¿À¿";
const char syl_bel_33[] PROGMEM = "°—";
const char syl_bel_34[] PROGMEM = "¬≈";
const char syl_bel_35[] PROGMEM = "’¿";
const char syl_bel_36[] PROGMEM = "¬Œ";
const char syl_bel_37[] PROGMEM = " Œ";
const char syl_bel_38[] PROGMEM = "¿«";
const char syl_bel_39[] PROGMEM = "«≤";
const char syl_bel_40[] PROGMEM = "≤÷";
const char syl_bel_41[] PROGMEM = "¿¡";
const char syl_bel_42[] PROGMEM = "— ";
const char syl_bel_43[] PROGMEM = "¿°";
const char syl_bel_44[] PROGMEM = "Õ≈";
const char syl_bel_45[] PROGMEM = "Õ”";
const char syl_bel_46[] PROGMEM = "¡¿";
const char syl_bel_47[] PROGMEM = "¿“";
const char syl_bel_48[] PROGMEM = "À≈";
const char syl_bel_49[] PROGMEM = "Àﬂ";
const char syl_bel_50[] PROGMEM = "—“¿";
const char syl_bel_51[] PROGMEM = "—÷";
const char syl_bel_52[] PROGMEM = "≤Õ";
const char syl_bel_53[] PROGMEM = "—œ";
const char syl_bel_54[] PROGMEM = "ƒ«≤";
const char syl_bel_55[] PROGMEM = "ƒ«≈";
const char syl_bel_56[] PROGMEM = "¿¬¿";
const char syl_bel_57[] PROGMEM = "¬€";
const char syl_bel_58[] PROGMEM = "÷÷";
const char syl_bel_59[] PROGMEM = "—¿";
const char syl_bel_60[] PROGMEM = "Œ–";
const char syl_bel_61[] PROGMEM = "–›";
const char syl_bel_62[] PROGMEM = " ≤";
const char syl_bel_63[] PROGMEM = "¿÷‹";
const char syl_bel_64[] PROGMEM = "°—ﬂ";
const char syl_bel_65[] PROGMEM = "ÀŒ";
const char syl_bel_66[] PROGMEM = "≈–";
const char syl_bel_67[] PROGMEM = "√Œ";
const char syl_bel_68[] PROGMEM = "ŒÀ";
const char syl_bel_69[] PROGMEM = "≤À";
const char syl_bel_70[] PROGMEM = "÷÷¿";
const char syl_bel_71[] PROGMEM = "¿À≤";
const char syl_bel_72[] PROGMEM = "œ–¿";
const char syl_bel_73[] PROGMEM = "¬≤";
const char syl_bel_74[] PROGMEM = "¬ﬂ";
const char syl_bel_75[] PROGMEM = "Œƒ";
const char syl_bel_76[] PROGMEM = "œ–€";
const char syl_bel_77[] PROGMEM = "Œ—";
const char syl_bel_78[] PROGMEM = "”—";
const char syl_bel_79[] PROGMEM = "«≈";
const char syl_bel_80[] PROGMEM = "¿√¿";
const char syl_bel_81[] PROGMEM = "¿œ";
const char syl_bel_82[] PROGMEM = " –";
const char syl_bel_83[] PROGMEM = "–”";
const char syl_bel_84[] PROGMEM = "≈Õ";
const char syl_bel_85[] PROGMEM = "”À";
const char syl_bel_86[] PROGMEM = "«ﬂ";
const char syl_bel_87[] PROGMEM = "€Õ";
const char syl_bel_88[] PROGMEM = "ŒÕ";
const char syl_bel_89[] PROGMEM = "Ã≈";
const char syl_bel_90[] PROGMEM = "≤—";
const char syl_bel_91[] PROGMEM = "≈À";
const char syl_bel_92[] PROGMEM = "œ¿ƒ";
const char syl_bel_93[] PROGMEM = "À¿—";
const char syl_bel_94[] PROGMEM = "ﬂƒ";
const char syl_bel_95[] PROGMEM = "ƒŒ";
const char syl_bel_96[] PROGMEM = "Õﬂ";
const char syl_bel_97[] PROGMEM = "Õ€";
const char syl_bel_98[] PROGMEM = "«Õ";
const char syl_bel_99[] PROGMEM = "∆€";
const char syl_bel_100[] PROGMEM = "¿ƒ¿";
const char syl_bel_101[] PROGMEM = "À‹";
const char syl_bel_102[] PROGMEM = "œŒ";
const char syl_bel_103[] PROGMEM = "¿–¿";
const char syl_bel_104[] PROGMEM = "”Ã";
const char syl_bel_105[] PROGMEM = "≤÷‹";
const char syl_bel_106[] PROGMEM = "¿…";
const char syl_bel_107[] PROGMEM = "ƒ”";
const char syl_bel_108[] PROGMEM = "∆¿";
const char *const syl_bel_table[] PROGMEM = { syl_bel_0,syl_bel_1,syl_bel_2,syl_bel_3,syl_bel_4,syl_bel_5,syl_bel_6,syl_bel_7,syl_bel_8,syl_bel_9,syl_bel_10,syl_bel_11,syl_bel_12,syl_bel_13,syl_bel_14,syl_bel_15,syl_bel_16,syl_bel_17,syl_bel_18,syl_bel_19,syl_bel_20,syl_bel_21,syl_bel_22,syl_bel_23,syl_bel_24,syl_bel_25,syl_bel_26,syl_bel_27,syl_bel_28,syl_bel_29,syl_bel_30,syl_bel_31,syl_bel_32,syl_bel_33,syl_bel_34,syl_bel_35,syl_bel_36,syl_bel_37,syl_bel_38,syl_bel_39,syl_bel_40,syl_bel_41,syl_bel_42,syl_bel_43,syl_bel_44,syl_bel_45,syl_bel_46,syl_bel_47,syl_bel_48,syl_bel_49,syl_bel_50,syl_bel_51,syl_bel_52,syl_bel_53,syl_bel_54,syl_bel_55,syl_bel_56,syl_bel_57,syl_bel_58,syl_bel_59,syl_bel_60,syl_bel_61,syl_bel_62,syl_bel_63,syl_bel_64,syl_bel_65,syl_bel_66,syl_bel_67,syl_bel_68,syl_bel_69,syl_bel_70,syl_bel_71,syl_bel_72,syl_bel_73,syl_bel_74,syl_bel_75,syl_bel_76,syl_bel_77,syl_bel_78,syl_bel_79,syl_bel_80,syl_bel_81,syl_bel_82,syl_bel_83,syl_bel_84,syl_bel_85,syl_bel_86,syl_bel_87,syl_bel_88,syl_bel_89,syl_bel_90,syl_bel_91,syl_bel_92,syl_bel_93,syl_bel_94,syl_bel_95,syl_bel_96,syl_bel_97,syl_bel_98,syl_bel_99,syl_bel_100,syl_bel_101,syl_bel_102,syl_bel_103,syl_bel_104,syl_bel_105,syl_bel_106,syl_bel_107,syl_bel_108 };
...
void drawRandomSyllable() {
    char buf[10];
    char *cp;
    const char *const *syl_table;
    int sylind;
    int maxsylind;
    switch (EEPROM.read(0)) {
        case 0: //eng
            syl_table = syl_eng_table;
            maxsylind = sizeof(syl_eng_table)/sizeof(char*);
            break;
        case 1: //rus
            syl_table = syl_rus_table;
            maxsylind = sizeof(syl_rus_table)/sizeof(char*);
            break;
        default: //bel
            syl_table = syl_bel_table;
            maxsylind = sizeof(syl_bel_table)/sizeof(char*);
            break;
        break; 
    }
    do {
